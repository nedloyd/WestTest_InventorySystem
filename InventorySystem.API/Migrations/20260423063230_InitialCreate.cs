        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockKeepingUnitCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batches_ProductId_CreatedAt",
                table: "Batches",
                columns: new[] { "ProductId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Batches_ProductId_IsActive_RemainingQuantity",
                table: "Batches",
                columns: new[] { "ProductId", "IsActive", "RemainingQuantity" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_StockKeepingUnitCode",
                table: "Products",
